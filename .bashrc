...
# Some colors used by the prompt
# GRAY="\[\033[1;30m\]"
# BLUE="\[\033[0;34m\]"
# MAGENTA="\[\033[35;35m\]"
# YELLOW="\[\033[1;33m\]"
...
# todotxt
TODOTXT_PATH=$HOME/Projets/Tierce/todo.txt-cli
TODOTXT_BIN=$TODOTXT_PATH/todo.sh
alias t=$TODOTXT_BIN
_todoElsewhere()
{
    local _todo_sh=$TODOTXT_BIN
    _todo "$@"
}
source $TODOTXT_PATH/todo_completion
complete -F _todoElsewhere $TODOTXT_BIN
